...
"""
fonction permetant de récuperer uniquement les émotions montrées
def on_veut_que_montrer(table):
    ...
    #print(list_modes)
    montrer.to_csv("montree.csv", index=False)
    return montrer
"""
...
def on_veut_les_SitEmo(montrer_tableau):
    ...
    table2.to_csv("./files/EmoTotal_SitEmo_lemma.tsv", index=False, sep='\t') 
...
def main(): 
    ...
    tableau2= on_veut_les_SitEmo(table)
    print(tableau2)
